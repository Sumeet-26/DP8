...
public class SavingAcc8 extends Account8 {
	...
	public SavingAcc8(int accNo, String name,String type, String branch, String ifsc, double bal,int time) {
	...
	public static void setIntrestRate(float intrestRate) {
		SavingAcc8.intrestRate = intrestRate;
	}
...
public void calculateSI() {
	...
	{
		SavingAcc8 obj= new SavingAcc8( 233234,"Yogesh Nawale","Saving Account","pune","Sbin000126",50000,5);
